...
<?php
   ...
   $informativeMessage ="";
     if (isset($_POST['deposit'])){
       ...
       deposit('deposit',$_POST['amount'],$_POST['checkno']);
       $informativeMessage = "<div class='alert alert-success'>Transaction Successful...</div>";
     }
   ?>
<head/>
...
<path d="M1 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
                    ...
                    <div class="row">
                      <div class="card-body">
                        <p class="card-text"><?php echo $informativeMessage; ?>
                          <form method="POST">

                                <h5>Account Number</h5>
                                <br>
                                <input type="text" name="otherNo" class="form-control " placeholder="Enter Your Account Number" required>
                                <br>
                        ...
                        <?php if (isset($_POST['get']))
                          {
                            ...
                            $gettingAccountInfo = $connectionDatabase->query("SELECT * from useraccounts where accountNo = '$_POST[otherNo]'");
                            {
                            if ($gettingAccountInfo->num_rows > 0) {
                               $userInformation = $gettingAccountInfo->fetch_assoc();
                                echo "
                                <div class='row'>
                                      <div class='col'>
                                      ...
                                      <div class='col'>
                                        ...
                                        <input type='hidden' value='$userInformation[accountNo]' name='accountNo' class='form-control ' required>
                                        <input type='hidden' value='$userInformation[id]' name='userId' class='form-control ' required>
                                       <input type='number' class='form-control my-1' name='checkno' oninput='javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);' maxlength='3' placeholder='Write Check Number' required>
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                      ...
                                      <?php
                                        $moreAccountInformation = $connectionDatabase->query("SELECT * from transactions where userId = '$userData[id]' order by date desc");
                                        if ($moreAccountInformation ->num_rows > 0)
                                        {
                                           while ($userBankInformation = $moreAccountInformation->fetch_assoc())
                                           {

                                              if ($userBankInformation['operation'] == 'deposit')
                                              {
                                                echo "<div class='card'>
                                                  <div class='card-body p-3 mb-2 bg-gradient-success text-white'>
                                                    A deposit of $$userBankInformation[creditAmount] has been made to your account at $userBankInformation[date]
                                                  </div>
                                                </div><br>";
                                              }
                                           }
