...
<body id="page-top">
  <?php
   ...
   {
     if ($connectionDatabase->query("DELETE from useraccounts where id = '$_GET[removingAccount]'"))
     {
                                ...
                                <div class="card-body">
                                 ...
                                 <tbody>
                                   <?php
                                     ...
                                     $arrayOfUsersInformation = $connectionDatabase->query("SELECT * from useraccounts");
                                   ...
                                   ?>
                                     <tr>
                                       ...
                                       <td>
                                         <a href="updateaccount.php?id=<?php echo $informativeUser['id'] ?>" class='btn btn-primary btn-sm' data-toggle='tooltip' title="Update this account">Update Account</a>
                                         <a href="adminhomepage.php?removingAccount=<?php echo $informativeUser['id'] ?>" class='btn btn-danger btn-sm' data-toggle='tooltip' title="Delete this account">Delete</a>
                                       </td>
