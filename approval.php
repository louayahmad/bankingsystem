...
<body id="page-top">
  <?php
   ...
   mysqli_query($connectionDatabase, "INSERT INTO useraccounts (name,ssn,accountNo,accountType, address,email,password,balance,number,cardpin) values ('$_POST[name]','$hashedssn','$_POST[accountNo]','$_POST[accountType]','$_POST[address]','$_POST[email]','$hashed','$_POST[balance]','$_POST[number]','$_POST[cardpin]')");
   mysqli_query($connectionDatabase, "DELETE FROM newaccountrequests WHERE name='$_POST[name]'");
   echo "<div class='alert alert-info text-center'>Account has been approved.</div>";
   header("location:accountcreationrequests.php");
   
   }

   $result = mysqli_query($connectionDatabase,"SELECT * FROM newaccountrequests WHERE id='" . $_GET['id'] . "'");
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                  ...
                                  <div class="form-group">
                                  <label>Set Account Number</label>
                                  <input type="number" name="accountNo" class="form-control" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="9" value="<?php echo $row["accountNo"]; ?>" required>
                                  </div>
                                  <div class="form-group">
                                  <label>Email</label>
                                  ...
                                  <input type="text" name="number" class="form-control" value="<?php echo $row["number"]; ?>" readonly>
                                  </div>
                                  <div class="form-group">
                                  <label>SSN</label>
                                  ...
                                  <div class="form-group">
                                  <label>Set Card Pin</label>
                                  <input type="number" name="cardpin" class="form-control" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="4" value="<?php echo $row["cardpin"]; ?>" required >
                                  </div>
                                  <div class="form-group">
                                  <label>Balance</label>
                                  <input type="text" name="balance" class="form-control" value="<?php echo $row["balance"]; ?>" readonly >
                                  </div>
