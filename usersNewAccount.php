            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    if (isset($_POST['creationOfAccount']))
                    {
                      ...
                      if (!$connectionDatabase->query("INSERT INTO useraccounts (name,ssn,accountNo,accountType, address,email,password,balance,number,cardpin) values ('$_POST[name]','$hashedssn','$_POST[accountNo]','$_POST[accountType]','$_POST[address]','$_POST[email]','$hashed','$_POST[balance]','$_POST[number]','$_POST[cardpin]')")) {
                        echo "<div claass='alert alert-success'>Cannot add user to the database:".$connectionDatabase->error."</div>";
                      }
                      else
                        echo "<div class='alert alert-info text-center'>New account has been added successfully</div>";
                                      ...
                                      <table class="table">
                                        <tbody>
                                          <tr>
                                            ...
                                            <th>SSN</th>
                                            <td><input type="number" name="ssn" class="form-control input-sm" required oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="9"></td>
                                          </tr>
                                          <tr>
                                            <th>Account Number</th>
                                            <td><input type="" name="accountNo"  class="form-control input-sm" required oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="9"></td>
                                            <th>Account Type</th>
                                            <td>
                                          ...
                                          <td><input type="email" name="email" class="form-control input-sm" required></td>
                                            ...
                                            <th>Password</th>
                                            <td><input type="password" name="password" class="form-control input-sm" required oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="15"></td>
                                          ...
                                          <tr>
                                            ...
                                            <th>Card Pin</th>
                                            <td><input type="number" name="cardpin" class="form-control input-sm" required oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="4"></td>


                                          </tr>
                                          <tr>
                                            <td colspan="4">
                                              <button type="submit" name="creationOfAccount" class="btn btn-primary btn-sm">Create Account</button>
